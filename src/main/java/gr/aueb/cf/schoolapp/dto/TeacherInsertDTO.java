...
public class TeacherInsertDTO {
    ...
    //γινεται εδω το validation με τα annotations (bean validation)

    @NotNull(message = "Το όνομα δεν μπορεί να είναι κενό.")
    @Size(min = 2, max = 255, message = "Το όνομα πρέπει να είναι μεταξύ " +
            "2-255 χαρακτήρων")
    private String firstname;
    @NotNull(message = "Το επώνυμο δεν μπορεί να είναι κενό")
    @Size(min = 2, max = 255, message = "Το επώνυμο πρέπει να είναι μεταξύ " +
            "2-255 χαρακτήρων")
